...
export class SimulationController {
    constructor() {
        ...
        this.safeNodes = [];
        // Pre-compute Safe Nodes (Nearest graph nodes to EXITS)
        this.identifySafeNodes();
    ...
    identifySafeNodes() {
        ...
        if (EXITS && EXITS.length > 0) {
            EXITS.forEach(exit => {
                ...
                if (closestNode) {
                    this.safeNodes.push(closestNode);
                }
            });
        }
        console.log("Identified Safe Nodes:", this.safeNodes);
    }
